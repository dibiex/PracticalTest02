...
public class ServerThread extends Thread {
    ...
    private HashMap<String, DictionaryWord> data = null;
    ...
    public synchronized void setData(String word, DictionaryWord dictionaryWord) {
        this.data.put(word, dictionaryWord);
    }

    public synchronized HashMap<String, DictionaryWord> getData() {
        return data;
    }
